...
public class AnimeContributionCreatedPublisher {
    private static final Logger log = LoggerFactory.getLogger(AnimeContributionCreatedPublisher.class);
    ...
    public void publish(AnimeContributionCreatedEvent event) {
        ...
        log.info("Anime contribution created event sent to stream. animeId={} | personId={}", event.getAnimeId(), event.getPersonId());
    }
}
