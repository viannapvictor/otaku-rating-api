...
public class AnimeDeletedPublisher {
    private static final Logger log = LoggerFactory.getLogger(AnimeDeletedPublisher.class);
    ...
    public void publish(AnimeDeletedEvent event) {
        ...
        log.info("Anime deleted event sent to stream. animeId={}", event.getAnimeId());
    }
}
