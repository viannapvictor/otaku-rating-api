package com.otaku.rating.user.core.model.valueobject;

import com.otaku.rating.generic.core.utils.CharacterUtils;
import com.otaku.rating.user.core.exception.UserNameInvalidCharacterException;
import com.otaku.rating.user.core.exception.UserNameInvalidFormatException;
import com.otaku.rating.user.core.exception.UserNameInvalidLengthException;
import com.otaku.rating.user.core.exception.UserNameNullException;
import lombok.*;
