...
import com.otaku.rating.user.core.exception.EmailInvalidFormatException;
import com.otaku.rating.user.core.exception.EmailInvalidLengthException;
import com.otaku.rating.user.core.exception.EmailNullException;
import lombok.*;
