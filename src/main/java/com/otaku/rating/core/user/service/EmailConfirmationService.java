...
public interface EmailConfirmationService {
    EmailConfirmation confirmEmail(String code, Email currentEmail) throws ValidationException;
    boolean existsByEmail(Email email);
    EmailConfirmation addEmailConfirmation(User user, Email newEmail) throws ValidationException;
